...
#'
#' This dataset was constructed from the publically-available WASH Benefits Bangaldesh cluster randomised controlled trial dataset.
...
#' The trial found no evidence of an effect of an intervention to improve sanitation including construction of improved latrines on child length-for-age Z-scores.
...
#' The authors concluded that observational analyses of water, sanitation, and hygeine (WASH) interventions may suffer from unmeasured confounding.
...
#' We would like a variable that is associated with socio-economic status (SES) because that is a likely cause of the unmeasured confounding highlighted by Arnold et al. (2018).
...
#' \describe{
#'  \item{treatment} {For studies 1 and 2, 1 if participant was in the "Sanitation" arm and 0 if participant was in the "Control" arm.
#'                    For study 3, 1 if participant's household had an improved latrine at baseline and 0 otherwise.}
...
#'  \item{hfiacat} {Category of household food insecurity.}
